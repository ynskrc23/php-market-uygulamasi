	...
	<div class="left-sidebar">
		<h2>reyon | ürün</h2>
			...
			<div class="brands_products"><!--brands_products-->
				...
				<div class="panel-group category-products" id="accordian">
					<input class="form-control" type="text" name="konumbilgi" maxlength="100" id="message-text4" disabled="disabled"  placeholder="Konum İçin Lütfen Giriş Yapınız" required/>	
					<br> 
