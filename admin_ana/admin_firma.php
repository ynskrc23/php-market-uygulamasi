       ...
       <div id="left">
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height:1200px;">
                <div class="row">
                    <div class="col-lg-12">
                        <h2>ADMİN FİRMA İŞLEMLERİNE HOŞGELDİNİZ</h2>
                    </div>
                </div>
                <hr />              
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php                               
                                        $veri= $db->query("SELECT * FROM uye where uye_tur='Firma'", PDO::FETCH_ASSOC);            
                                            foreach($veri as $row){  
                                               $row['uye_id'];
                                               $a=$row['uye_id'];
                                    ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="center">                                           
                                                ...
                                                <button type="submit" name="firma_delete" class="btn btn-danger">Delete</button></a>
                                            </td>
                                        </tr>                                                          
                                    </tbody>
                                    <?php
