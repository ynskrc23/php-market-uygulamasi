              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li><a href="admin_mailbox.php"><i class="fa fa-inbox"></i> Gelen Kutusu <span class="label label-primary pull-right"></span></a></li>
                    <li class="active"><a href="admin_send_mail.php"><i class="fa fa-envelope-o"></i> Gönderilen</a></li>
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table class="table table-hover table-striped">                    
                        <tbody>
                        <?php  
                            $veri = $db->prepare("SELECT * FROM mesaj where mesaj_gonderen='$uye'"); 
                            $veri ->execute();
                                if($veri->rowCount()){                           
                                foreach($veri as $row){  
                                    $row['mesaj_id'];
