                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="bildirim">                           
                            ...
                            <?php echo "<a href='admin_bildirim_kapat.php?id=".$a."'>";?>Bildirimi Okundu Say</a>
                            </span> 
                            <b>Mesaj Gönderen:</b> <?php echo $row['mesaj_gonderen']; ?><br>
                            <h5><b>Mesaj Konusu:</b> <?php echo $row['mesaj_konu']; ?></h5>
                            <?php echo "<a href='admin_read_mail.php?id=".$a."' class='btn btn-primary btn-sm'>";?>Bildirimi Oku</a>
                            <span class="pull-right">
